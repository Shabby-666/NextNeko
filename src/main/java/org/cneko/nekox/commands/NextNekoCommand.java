...
public class NextNekoCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            String pluginVersion = getSafeMessage("plugin.version", "Version: " + getPluginVersion());
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "v":
                ...
                String versionFull = getSafeMessage("plugin.version_full", getPluginVersion());
                // 为版本消息添加前缀
